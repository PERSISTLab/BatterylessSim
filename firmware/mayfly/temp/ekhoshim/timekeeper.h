 ...
 * @return               [description]
 */
inline unsigned int fast_tardis(unsigned int _adc_14_value) 
{
	unsigned int left = _adc_14_value >> SHIFT_BITS;
