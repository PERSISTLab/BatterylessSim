...
/** 
 * EUSCI - for newest MSP430's (e.g msp430fr6989)
 * 
 * The eUSCI_A does UART, while the eUSCI_B does not
 * 
 * @author Unknown
 * @author Matthew Furlong 
 */
public class EUSCI_A extends EUSCI implements DMATrigger, USARTSource {
   
    // Specific USCI A registers
    private static final int MCTL = 0x08;
    private static final int STAT = 0x0a;
    
    // Interrupt related
    private static final int IE = 0x1a;
    private static final int IFG = 0x1c;
    private static final int IV = 0x1e;
